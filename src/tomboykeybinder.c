...
static void grab_ungrab_with_ignorable_modifiers(GdkWindow *rootwin, Binding *binding,
                                                 gboolean grab)
{
        guint mod_masks[] = {
                0, /* modifier only */
...
static GdkFilterReturn filter_func(GdkXEvent *gdk_xevent, GdkEvent *event G_GNUC_UNUSED,
